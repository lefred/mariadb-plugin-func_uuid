...
```
MariaDB > SELECT HEX(UUID_TO_BIN('019c6b16-2736-7c48-ba54-b5084ffd51dc'));
+----------------------------------------------------------------+
| HEX(UUID_TO_BIN('019c6b16-2736-7c48-ba54-b5084ffd51dc'))        |
+----------------------------------------------------------------+
| 019C6B1627367C48BA54B5084FFD51DC00                             |
+----------------------------------------------------------------+

MariaDB > SELECT HEX(UUID_TO_BIN('019c6b16-2736-7c48-ba54-b5084ffd51dc', 1));
+----------------------------------------------------------------+
| HEX(UUID_TO_BIN('019c6b16-2736-7c48-ba54-b5084ffd51dc', 1))     |
+----------------------------------------------------------------+
| BA54B5084FFD51DC7C482736019C6B1601                             |
+----------------------------------------------------------------+

MariaDB > SELECT BIN_TO_UUID(UUID_TO_BIN('019c6b16-2736-7c48-ba54-b5084ffd51dc', 1));
+----------------------------------------------------------------+
| BIN_TO_UUID(UUID_TO_BIN('019c6b16-2736-7c48-ba54-b5084ffd51dc',1)) |
+----------------------------------------------------------------+
| 019c6b16-2736-7c48-ba54-b5084ffd51dc                           |
+----------------------------------------------------------------+
```
